...
// Envia o tokenId + cobranca para o endpoint publico da Integracao (n8n),
...
async function enviarParaIntegracao(tokenId: string) {
...
export function CheckoutForm() {
  ...
  async function handlePay() {
    ...
    setStatus('Cobranca enviada a Integracao.')
  }
